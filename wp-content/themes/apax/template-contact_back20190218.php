...
<div class="row" onload="initialize()">
 ...
 <div class="col-md-6 col-xs-12" style="padding-left:15%;">
	<div id="map_canvas" style="top: 10px; left: 25px; width:510px; height:220px; float: left"></div>
 </div>
 <div class="col-md-6 col-xs-12" style="padding-right:15%;">
	<div id="map_canvas_2" style="top: 10px; left: 75px; width:510px; height:220px"></div>
 </div>
